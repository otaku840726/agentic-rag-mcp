...
class EmbeddingCache:
    ...
    def clear(self):
        ...
        self.cache_dir.mkdir(parents=True, exist_ok=True)
        self.index = {"version": 1, "model": None, "entries": {}}
        self._save_index()
...
if __name__ == "__main__":
    ...
    # 保存
    cache.set(test_content, test_embedding, "text-embedding-3-small")

    # 讀取
    result = cache.get(test_content, "text-embedding-3-small")
